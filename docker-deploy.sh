...
REMOTE_STAGING='ubuntu@ec2-18-222-206-211.us-east-2.compute.amazonaws.com'
REMOTE_DEVELOPMENT='ubuntu@ec2-18-218-192-105.us-east-2.compute.amazonaws.com'
...
if [ "$1" != "" ]; then
	...
	DEFAULT_PEM_PATH='ssh/wellnessapp.pem'
